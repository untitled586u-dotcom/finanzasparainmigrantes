import { ArrowRight, BookOpen, CheckCircle2, FileText, Landmark, HandCoins, ReceiptText, Send, ShieldCheck, CreditCard } from "lucide-react";
...
const iconMap: Record<string, typeof CreditCard> = { "credit-card": CreditCard, "shield-check": ShieldCheck, landmark: Landmark, send: Send, "hand-coins": HandCoins, receipt: ReceiptText };
